// Generated by gencpp from file ntuc/lift.msg
// DO NOT EDIT!


#ifndef NTUC_MESSAGE_LIFT_H
#define NTUC_MESSAGE_LIFT_H
...
struct lift_
{
  ...
  typedef boost::shared_ptr< ::ntuc::lift_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ntuc::lift_<ContainerAllocator> const> ConstPtr;

}; // struct lift_

typedef ::ntuc::lift_<std::allocator<void> > lift;

typedef boost::shared_ptr< ::ntuc::lift > liftPtr;
typedef boost::shared_ptr< ::ntuc::lift const> liftConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ntuc::lift_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ntuc::lift_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'ntuc': ['/home/rac/catkin_ws/src/ntuc/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ntuc::lift_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ntuc::lift_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ntuc::lift_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ntuc::lift_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ntuc::lift_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ntuc::lift_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ntuc::lift_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ntuc::lift_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe5880338d440c98cULL;
  static const uint64_t static_value2 = 0x58ce479e42b36bedULL;
};

template<class ContainerAllocator>
struct DataType< ::ntuc::lift_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ntuc/lift";
...
template<class ContainerAllocator>
struct Definition< ::ntuc::lift_<ContainerAllocator> >
{
  static const char* value()
  {
    return "##################################################\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ntuc::lift_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ntuc::lift_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ntuc::lift_<ContainerAllocator>& v)
  {
    s << indent << "cmd: ";
