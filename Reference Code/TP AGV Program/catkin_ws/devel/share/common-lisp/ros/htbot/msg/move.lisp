...
(cl:defmethod gap-val ((m <move>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:gap-val is deprecated.  Use htbot-msg:gap instead.")
  (gap m))

(cl:ensure-generic-function 'slp-val :lambda-list '(m))
(cl:defmethod slp-val ((m <move>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:slp-val is deprecated.  Use htbot-msg:slp instead.")
  (slp m))

(cl:ensure-generic-function 'elp-val :lambda-list '(m))
(cl:defmethod elp-val ((m <move>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:elp-val is deprecated.  Use htbot-msg:elp instead.")
  (elp m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <move>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'pa))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'gap))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let* ((signed (cl:slot-value msg 'slp)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'elp)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <move>) istream)
  "Deserializes a message object of type '<move>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'gap) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'slp) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'elp) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<move>)))
  ...
  "05f4bf5bce5c30ffe01fb09c18cbbd86")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'move)))
  "Returns md5sum for a message object of type 'move"
  "05f4bf5bce5c30ffe01fb09c18cbbd86")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<move>)))
  ...
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 rx~%float32 ry~%float32 rz~%float32 rw~%float32 pd~%float32 pa~%float32 gap~%int8 slp~%int8 elp~%int8 opt~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'move)))
  "Returns full string definition for message of type 'move"
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 rx~%float32 ry~%float32 rz~%float32 rw~%float32 pd~%float32 pa~%float32 gap~%int8 slp~%int8 elp~%int8 opt~%~%~%"))
