...
(cl:ensure-generic-function 'LPT-val :lambda-list '(m))
(cl:defmethod LPT-val ((m <mqueue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-srv:LPT-val is deprecated.  Use htbot-srv:LPT instead.")
  (LPT m))
...
(cl:defmethod func-val ((m <mqueue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-srv:func-val is deprecated.  Use htbot-srv:func instead.")
  (func m))

(cl:ensure-generic-function 'trolley-val :lambda-list '(m))
(cl:defmethod trolley-val ((m <mqueue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-srv:trolley-val is deprecated.  Use htbot-srv:trolley instead.")
  (trolley m))

(cl:ensure-generic-function 'trolleydist-val :lambda-list '(m))
(cl:defmethod trolleydist-val ((m <mqueue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-srv:trolleydist-val is deprecated.  Use htbot-srv:trolleydist instead.")
  (trolleydist m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <mqueue-request>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'LPT)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'align))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'func))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'trolley))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'trolleydist))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <mqueue-request>) istream)
  "Deserializes a message object of type '<mqueue-request>"
    ...
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'LPT) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'func) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'trolley) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'trolleydist) (roslisp-utils:decode-single-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<mqueue-request>)))
  ...
  "688bcf05bb0a3ea18504032392975cc6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'mqueue-request)))
  "Returns md5sum for a message object of type 'mqueue-request"
  "688bcf05bb0a3ea18504032392975cc6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<mqueue-request>)))
  ...
  (cl:format cl:nil "int16 cmd~%int8 LP~%int8 GN~%int8 LPT~%string gps~%string lps~%string pw~%float32 tx~%float32 ty~%float32 tz~%float32 rx~%float32 ry~%float32 rz~%float32 rw~%float32 prd~%float32 pra~%float32 psd~%float32 psa~%float32 prd1~%float32 pra1~%float32 psd1~%float32 psa1~%float32 align~%float32 func~%float32 trolley~%float32 trolleydist~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'mqueue-request)))
  "Returns full string definition for message of type 'mqueue-request"
  (cl:format cl:nil "int16 cmd~%int8 LP~%int8 GN~%int8 LPT~%string gps~%string lps~%string pw~%float32 tx~%float32 ty~%float32 tz~%float32 rx~%float32 ry~%float32 rz~%float32 rw~%float32 prd~%float32 pra~%float32 psd~%float32 psa~%float32 prd1~%float32 pra1~%float32 psd1~%float32 psa1~%float32 align~%float32 func~%float32 trolley~%float32 trolleydist~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <mqueue-request>))
  ...
  (cl:list 'mqueue-request
    ...
    (cl:cons ':trolleydist (trolleydist msg))
))
...
(cl:ensure-generic-function 'func-val :lambda-list '(m))
(cl:defmethod func-val ((m <mqueue-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-srv:func-val is deprecated.  Use htbot-srv:func instead.")
  (func m))

(cl:ensure-generic-function 'trolley-val :lambda-list '(m))
(cl:defmethod trolley-val ((m <mqueue-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-srv:trolley-val is deprecated.  Use htbot-srv:trolley instead.")
  (trolley m))

(cl:ensure-generic-function 'trolleydist-val :lambda-list '(m))
(cl:defmethod trolleydist-val ((m <mqueue-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-srv:trolleydist-val is deprecated.  Use htbot-srv:trolleydist instead.")
  (trolleydist m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<mqueue-response>)))
  ...
  (cl:format cl:nil "int16 status~%float32 tx~%float32 ty~%float32 tz~%float32 rx~%float32 ry~%float32 rz~%float32 rw~%float32 prd~%float32 pra~%float32 psd~%float32 psa~%float32 prd1~%float32 pra1~%float32 psd1~%float32 psa1~%int8 LP~%int8 cLP~%int8 nGP~%int8 cGN~%int8 nIQ~%int8 marked~%string gps~%string lps~%string lps1~%string lps2~%string lps3~%string lps4~%string lps5~%string lps6~%string lps7~%string lps8~%int8 marked1~%int8 marked2~%int8 marked3~%int8 marked4~%int8 marked5~%int8 marked6~%int8 marked7~%int8 marked8~%float32 align~%float32 func~%float32 trolley~%float32 trolleydist~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'mqueue-response)))
  "Returns full string definition for message of type 'mqueue-response"
  (cl:format cl:nil "int16 status~%float32 tx~%float32 ty~%float32 tz~%float32 rx~%float32 ry~%float32 rz~%float32 rw~%float32 prd~%float32 pra~%float32 psd~%float32 psa~%float32 prd1~%float32 pra1~%float32 psd1~%float32 psa1~%int8 LP~%int8 cLP~%int8 nGP~%int8 cGN~%int8 nIQ~%int8 marked~%string gps~%string lps~%string lps1~%string lps2~%string lps3~%string lps4~%string lps5~%string lps6~%string lps7~%string lps8~%int8 marked1~%int8 marked2~%int8 marked3~%int8 marked4~%int8 marked5~%int8 marked6~%int8 marked7~%int8 marked8~%float32 align~%float32 func~%float32 trolley~%float32 trolleydist~%~%~%~%"))
