...
(cl:defmethod cl:initialize-instance :after ((m <lift>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lift)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name htbot-msg:<lift> is deprecated: use htbot-msg:lift instead.")))
...
(cl:defmethod cfloor-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:cfloor-val is deprecated.  Use htbot-msg:cfloor instead.")
  (cfloor m))

(cl:ensure-generic-function 'dfloor-val :lambda-list '(m))
(cl:defmethod dfloor-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:dfloor-val is deprecated.  Use htbot-msg:dfloor instead.")
  (dfloor m))

(cl:ensure-generic-function 'inuse-val :lambda-list '(m))
(cl:defmethod inuse-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:inuse-val is deprecated.  Use htbot-msg:inuse instead.")
  (inuse m))

(cl:ensure-generic-function 'dooropen-val :lambda-list '(m))
(cl:defmethod dooropen-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:dooropen-val is deprecated.  Use htbot-msg:dooropen instead.")
  (dooropen m))

(cl:ensure-generic-function 'doorclose-val :lambda-list '(m))
(cl:defmethod doorclose-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:doorclose-val is deprecated.  Use htbot-msg:doorclose instead.")
  (doorclose m))

(cl:ensure-generic-function 'goingup-val :lambda-list '(m))
(cl:defmethod goingup-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:goingup-val is deprecated.  Use htbot-msg:goingup instead.")
  (goingup m))

(cl:ensure-generic-function 'goingdown-val :lambda-list '(m))
(cl:defmethod goingdown-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:goingdown-val is deprecated.  Use htbot-msg:goingdown instead.")
  (goingdown m))

(cl:ensure-generic-function 'stationary-val :lambda-list '(m))
(cl:defmethod stationary-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:stationary-val is deprecated.  Use htbot-msg:stationary instead.")
  (stationary m))

(cl:ensure-generic-function 'serviceavail-val :lambda-list '(m))
(cl:defmethod serviceavail-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:serviceavail-val is deprecated.  Use htbot-msg:serviceavail instead.")
  (serviceavail m))

(cl:ensure-generic-function 'epower-val :lambda-list '(m))
(cl:defmethod epower-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:epower-val is deprecated.  Use htbot-msg:epower instead.")
  (epower m))

(cl:ensure-generic-function 'fireservice-val :lambda-list '(m))
(cl:defmethod fireservice-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:fireservice-val is deprecated.  Use htbot-msg:fireservice instead.")
  (fireservice m))

(cl:ensure-generic-function 'beacon-val :lambda-list '(m))
(cl:defmethod beacon-val ((m <lift>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader htbot-msg:beacon-val is deprecated.  Use htbot-msg:beacon instead.")
  (beacon m))
