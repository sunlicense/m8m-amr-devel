...
class lumstatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('laserstatus')) {
        this.laserstatus = initObj.laserstatus
      }
      else {
        this.laserstatus = '';
      }
      if (initObj.hasOwnProperty('errorlog')) {
        this.errorlog = initObj.errorlog
      }
      else {
        this.errorlog = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [laserstatus]
    bufferOffset = _serializer.string(obj.laserstatus, buffer, bufferOffset);
    // Serialize message field [errorlog]
    bufferOffset = _serializer.string(obj.errorlog, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [laserstatus]
    data.laserstatus = _deserializer.string(buffer, bufferOffset);
    // Deserialize message field [errorlog]
    data.errorlog = _deserializer.string(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += object.laserstatus.length;
    length += object.errorlog.length;
    return length + 22;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new lumstatus(null);
    ...
    if (msg.laserstatus !== undefined) {
      resolved.laserstatus = msg.laserstatus;
    }
    else {
      resolved.laserstatus = ''
    }

    if (msg.errorlog !== undefined) {
      resolved.errorlog = msg.errorlog;
    }
    else {
      resolved.errorlog = ''
    }
