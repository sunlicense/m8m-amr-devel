...
class mqueueRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('LPT')) {
        this.LPT = initObj.LPT
      }
      else {
        this.LPT = 0;
      }
      ...
      if (initObj.hasOwnProperty('trolleydist')) {
        this.trolleydist = initObj.trolleydist
      }
      else {
        this.trolleydist = 0.0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [LPT]
    bufferOffset = _serializer.int8(obj.LPT, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.float32(obj.func, buffer, bufferOffset);
    // Serialize message field [trolley]
    bufferOffset = _serializer.float32(obj.trolley, buffer, bufferOffset);
    // Serialize message field [trolleydist]
    bufferOffset = _serializer.float32(obj.trolleydist, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [LPT]
    data.LPT = _deserializer.int8(buffer, bufferOffset);
    ...
    data.func = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [trolley]
    data.trolley = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [trolleydist]
    data.trolleydist = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.LPT !== undefined) {
      resolved.LPT = msg.LPT;
    }
    else {
      resolved.LPT = 0
    }
    ...
    if (msg.trolley !== undefined) {
      resolved.trolley = msg.trolley;
    }
    else {
      resolved.trolley = 0.0
    }

    if (msg.trolleydist !== undefined) {
      resolved.trolleydist = msg.trolleydist;
    }
    else {
      resolved.trolleydist = 0.0
    }
...
class mqueueResponse {
  ...
  static md5sum() {
    //Returns md5sum for a message object
    return '09f43b2c8e46aafbaf66b49ce2184a58';
  }
...
module.exports = {
  ...
  md5sum() { return '688bcf05bb0a3ea18504032392975cc6'; },
