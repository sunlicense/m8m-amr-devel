...
function checkCleaningStatus() {	
	...
	PM.get(function(value) {
		if (value == 5) {
			...
			document.getElementById("mode").innerHTML = "Re-Cleaning Completed.";	
			...
			document.getElementById("image").src="imgs/reclean.png";
    ...
    console.log('Result for service call on '
      ...
      + result.status);
		if (result.status == -1) {
			...
			if (pauseCleaning) {
				document.getElementById("mode").innerHTML = "Re-Cleaning Paused"; 
				...
				document.getElementById("mode").innerHTML = "Re-Cleaning Started"; 
...
function stopClean() {
	document.getElementById("mode").innerHTML = "Re-Cleaning Terminated";	
	document.getElementById("pausestart").innerHTML = "<h2>Dock</h2>";
	document.getElementById("pause").innerHTML = "<img src='imgs/dock.png' width='60px' height='60px' />";	
	document.getElementById("pause").onclick = function() {goDockStation()};
	document.getElementById("image").className="imgclean";
