...
*		Changes :
		...
		6.9.21 
			1. 11.55AM : ADDED 3 new sound on scheduling for globotix
*/
...
void play(int id) {
	...
	switch (id) {
		...
		case CHANGEMAPS://71
			delay = SEC2;
			ret = system("aplay ~/sound/ChangeMaps.wav &");		
			break;
		case CHECKNEWJOB://72
			delay = SEC1_2;
			ret = system("aplay ~/sound/CheckNewJob.wav &");		
			break;
		case DISABLEJOYSTICK://73
			delay = SEC1_2;
			ret = system("aplay ~/sound/DisableJoyStick.wav &");		
			break;
		case DISENGAGECLEANING://74
			delay = SEC2_2;
			ret = system("aplay ~/sound/DisengageCleaning.wav &");		
			break;
		case ENABLEJOYSTICK://75
			delay = SEC1_2;
			ret = system("aplay ~/sound/EnableJoyStick.wav &");		
			break;
		case ENGAGECLEANING://76
			delay = SEC2_2;
			ret = system("aplay ~/sound/EngageCleaning.wav &");		
			break;
		case LIFTARRIVEDMOVEINTOLIFT://77
			delay = SEC3_2;
			ret = system("aplay ~/sound/LIftArriveMoveintoLift.wav &");		
			break;
		case LIFTDOOROPENMOVEOUT://78
			delay = SEC4;
			ret = system("aplay ~/sound/LiftDoorOpenMoveout.wav &");		
			break;
		case LOBBYDOOROPENASKLIFT://79
			delay = SEC4;
			ret = system("aplay ~/sound/LobbyDoorOpenAskLift.wav &");		
			break;
		case DAILYSCHEDULE://80
			delay = SEC3_2;
			ret = system("aplay ~/sound/DailySchedule.wav &");		
			break;
		case WEEKLYSCHEDULE://81
			delay = SEC3;
			ret = system("aplay ~/sound/WeeklySchedule.wav &");		
			break;
		case MONTHLYSCHEDULE://82
			delay = SEC3;
			ret = system("aplay ~/sound/MonthlySchedule.wav &");		
			break;
